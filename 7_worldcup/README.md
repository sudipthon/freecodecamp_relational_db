This challenge has a databse worldcup with two tables ;teams,games

insert_data.sh is for inserting data from the file games.csv

queries.sh file is for making query that matches the output specified in expected_output.txt



You can follow below instructions to practice this locally on your device
